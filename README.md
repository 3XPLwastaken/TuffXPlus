...
3. Configure features in `config.yml` (`y0`, `registry`, `viablocks`,  `swimming`, `creative-items`, `restrictions`).
...
- ViaEntities: syncs modern entites to TuffX client without nametags.
